...
function GooglePlacesMap({
  ...
  return (
    <div className="relative h-full min-h-[560px] overflow-hidden rounded-[24px] bg-slate-100">
      <div
        ref={mapNodeRef}
      ...
      {error ? (
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-white/95 p-6">
          <div className="max-w-md rounded-2xl border border-rose-200 bg-rose-50 p-5 text-center">
            ...
            <div className="mt-2 text-xs font-semibold leading-5 text-rose-700">
              {
                error
              }
            </div>
      ...
      places.length ===
        ...
        <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center">
          <div className="rounded-2xl border border-slate-200 bg-white/95 px-5 py-4 text-center shadow-lg backdrop-blur">
