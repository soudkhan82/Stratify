  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(99,102,241,0.07),_transparent_25%),linear-gradient(180deg,#f7f9fc_0%,#edf2f7_100%)] px-2.5 py-3 text-slate-800 sm:px-4">
      <div className="mx-auto w-full max-w-[1580px]">
        ...
        <section className="grid items-stretch gap-3 xl:grid-cols-[230px_minmax(0,1fr)_420px]">
                    ...
                    (item) => {
                      ...
                      return (
                        <button
                          ...
                          className={[
                            "group flex w-full items-center gap-2.5 rounded-[11px] px-2.5 py-2.5 text-left transition",
                            active
                              ...
                              <div className="mt-2.5 flex flex-wrap items-center gap-3 border-t border-slate-100 pt-2.5">
                                {!details ? (
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1.5 text-[10px] font-medium text-indigo-700 transition hover:text-indigo-800 disabled:opacity-50"
                                  >
                                    {detailLoadingId ===
                                    place.id ? (
